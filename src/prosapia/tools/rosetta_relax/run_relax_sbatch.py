...
Usage:
    sapia run relaxed outputs/20260420_123035_grow_hairpin --table table1_...
    sapia run relaxed outputs/20260420_123035_grow_hairpin --table table1_... --max-concurrent 10
"""
